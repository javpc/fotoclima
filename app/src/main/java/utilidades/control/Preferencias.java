...
public class Preferencias {
    ...
    public boolean obtenerBoolean (String clave, boolean predeterminado) {
        return preferencias().getBoolean(clave, predeterminado);
    }
    public long obtenerLong (String clave,  long predeterminado) {
        return preferencias().getLong(clave, predeterminado);
    }
    public float obtenerFloat (String clave, float  predeterminado) {
        return preferencias().getFloat(clave,  predeterminado);
    }



    public String obtenerString (String clave, String predeterminado) {
        return preferencias().getString(clave, predeterminado);
    }
