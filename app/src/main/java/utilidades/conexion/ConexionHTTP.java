...
public class ConexionHTTP implements Runnable {
    ...
    private MiniEvento evento = new MiniEvento ();


    public static final String claveRespuesta = "conexion_respuesta";
    public static final String claveEstado = "conexion_estado";
